...
public class Supplier {
    ...
    public Supplier(String supplier_name, String supplier_item, String supplier_address, String supplier_contact_no){
    ...
    public Supplier(int supplier_id, String supplier_name, String supplier_item, String supplier_address, String supplier_contact_no) {
