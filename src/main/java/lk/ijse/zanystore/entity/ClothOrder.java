...
public class ClothOrder {
    ...
    public ClothOrder(String cloth_order_description, String cloth_order_start_date, String cloth_order_end_date, int customer_id){
    ...
    public ClothOrder(int cloth_order_id, String cloth_order_description, String cloth_order_start_date, String cloth_order_end_date, int customer_id) {
